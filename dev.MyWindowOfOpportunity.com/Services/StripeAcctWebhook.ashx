<%@ WebHandler Language="VB" Class="StripeAcctWebhook" %>
...
Public Class StripeAcctWebhook : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        Try
            ...
            blSiteManagement.parseHookMsg(siteNodes.accountHooks, jsonMsg)
        ...
        Catch ex As Exception
            ...
            sb.AppendLine("StripeAcctWebhook.ashx: ProcessRequest()")
