<%@ WebHandler Language="VB" Class="FundTransferRequest" %>
...
#Region "Handles"
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        Try
            ...
            'Run nightly update
            blPledges.submitFundTransfers(siteNodes.pendingTransfers)

        Catch ex As Exception
            Dim sb As New StringBuilder()
            sb.AppendLine("ERROR: \Handlers\FundTransferRequest.ashx : ProcessRequest()")
